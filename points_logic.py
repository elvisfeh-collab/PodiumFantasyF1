...
def procesar_todo(supabase):
    ...
    for pred in preds_res.data:
        ...
        # 3. Guardar el desglose detallado en la tabla 'puntuaciones_gp' (si existe o la actualiza por GP)
        try:
            ...
            # En caso de que la tabla puntuaciones_gp tenga otra estructura de índices, evitamos que rompa el script
            pass
